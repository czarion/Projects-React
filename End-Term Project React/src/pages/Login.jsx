    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="glass-panel w-full max-w-md p-8 rounded-2xl shadow-xl">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-center">Smart Travel Planner</h1>
        ...
        <p className="mt-6 text-center text-sm text-[var(--color-text-secondary)]">
          Don't have an account? <Link to="/signup" className="text-[var(--color-accent)] hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
